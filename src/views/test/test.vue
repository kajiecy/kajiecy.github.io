<template>
    <div style="width: 100vw;height: 100vh">
        <div style="display: grid;grid-template-columns: 240px 1fr;height: 100vh">
            <div style="background-color: #2ab1f0;">
            </div>
            <div style="background-color: #42b983" >
                <article class="markdown-body">
                    <pre style="word-break: normal">
                        <code>
                            // 假设这是一行很长的代码，到底有多长呢。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。
                            // 假设这是一行很长的代码，到底有多长呢。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。
                            // 假设这是一行很长的代码，到底有多长呢。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。
                            // 假设这是一行很长的代码，到底有多长呢。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。从前有座山山上有座庙。。。。
                        </code>
